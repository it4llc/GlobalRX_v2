// src/app/api/data-rx/fields/[id]/toggle-available/route.ts
...
/**
 * PATCH /api/data-rx/fields/[id]/toggle-available
 *
 * Toggles the availability of a field requirement
 *
...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    try {
      ...
      logger.error('Database error in PATCH /api/data-rx/fields/[id]/toggle-available:', dbError);
      return NextResponse.json(
    ...
    logger.error('Error in PATCH /api/data-rx/fields/[id]/toggle-available:', error);
    return NextResponse.json(
