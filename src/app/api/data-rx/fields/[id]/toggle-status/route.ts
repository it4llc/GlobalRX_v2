...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    try {
      ...
      console.error('Database error in PATCH /api/data-rx/fields/[id]/toggle-status:', dbError);
      return NextResponse.json(
    ...
    console.error('Error in PATCH /api/data-rx/fields/[id]/toggle-status:', error);
    return NextResponse.json(
