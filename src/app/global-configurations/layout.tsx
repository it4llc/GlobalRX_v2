                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`py-2 px-4 text-center border-b-2 font-medium text-sm cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 rounded-t-md ${
                          isActive
