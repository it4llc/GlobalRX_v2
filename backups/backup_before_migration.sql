...
COPY public.dsx_requirements (id, name, type, "serviceId", "fieldData", "documentData", "formData", "createdAt", "updatedAt") FROM stdin;
7456d517-e212-454d-8d4a-e19ddd077ba7	Company Name	field	4b9d6a10-6861-426a-ad7f-60eb94312d0d	\N	\N	\N	2025-04-06 16:07:35.433	2025-04-06 16:07:35.433
61588fb6-5a89-4b27-bf6f-1a6d07b48a1f	Company Name	field	383f3f2f-3194-4396-9a63-297f80e151f9	{"options": [], "dataType": "text", "shortName": "Company Name", "instructions": "Provide the full company name.", "retentionHandling": "no_delete"}	\N	\N	2025-04-06 16:07:26.568	2025-04-06 16:07:26.568
\.
...
--
-- Name: dsx_requirements_serviceId_type_idx; Type: INDEX; Schema: public; Owner: andyhellman
--

CREATE INDEX "dsx_requirements_serviceId_type_idx" ON public.dsx_requirements USING btree ("serviceId", type);
...
ALTER TABLE ONLY public.customers
    ADD CONSTRAINT "customers_billingAccountId_fkey" FOREIGN KEY ("billingAccountId") REFERENCES public.customers(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.customers
    ADD CONSTRAINT "customers_masterAccountId_fkey" FOREIGN KEY ("masterAccountId") REFERENCES public.customers(id) ON DELETE SET NULL;
...
--
-- Name: dsx_requirements dsx_requirements_serviceId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: andyhellman
--

ALTER TABLE ONLY public.dsx_requirements
    ADD CONSTRAINT "dsx_requirements_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES public.services(id) ON UPDATE CASCADE ON DELETE RESTRICT;
